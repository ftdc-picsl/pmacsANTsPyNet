...
parser = argparse.ArgumentParser(formatter_class=argparse.RawTextHelpFormatter,
                                 prog='shiva_wmh_segmentation', add_help = False, description='''
Wrapper for shiva_wmh_segmentation in AntsPyNet.
...
wmh = antspynet.shiva_wmh_segmentation(flair, t1w, which_model = "all", verbose=True)
